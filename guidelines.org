...
* Introduction
There are many reasons to share your scientific software.

- Collaborations within the group
- Collaborations with other groups
- Scientific output
- Publicity for you, and the group
...
control, or e.g. using Linux. Instead, it is about everything you need /after/
...
a a project structure, and some guidelines, for sharing your software projects.
In some sense, this is a checklist for your software package to make sure that
it is easy to use for others, yet allows you to keep the freedom to develop your
software further.

The second part, /selected topics/, is a how-to guide for common tasks that you
...
In the most extreme case, the result is a single script, say
=reconstruction_algorithm.py=, containing some classes, functions and some code
that applies them to some data set.
